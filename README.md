...
A simple 4-instruction microprocessor designed in Verilog for the Logic Design course at Seoul National University. 
Project was implemented and tested on a custom FPGA board. 
...
* **4-Instruction Support:** The CPU can execute four basic instructions:
    ...
    * `JUMP`: Jumps to a specific instruction address.
